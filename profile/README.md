...
Ongoing frontend implementation support inside an existing team and codebase.
...
Scoped accessibility review of selected pages, flows, and interface patterns, with prioritized findings and practical next steps.
